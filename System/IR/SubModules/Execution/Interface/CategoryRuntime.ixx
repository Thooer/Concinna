...
inline RunResult interpret_fast_adapter(const MorphismIR& ir, const ObjectDescriptor& od, Span<const Value> args) {
...
struct JITAdapter {
    ...
    static RunResult run(const NativeFn& nf, Span<const Value> args) { return Foundation::IRSystem::run(nf, args); }
};
