...
Expect<USize> File::Read(FileHandle, Span<Byte, DynamicExtent>) noexcept { return Expect<USize>::Err(Err(StatusDomain::System(), StatusCode::Unsupported)); }
Expect<USize> File::Write(FileHandle, Span<const Byte, DynamicExtent>) noexcept { return Expect<USize>::Err(Err(StatusDomain::System(), StatusCode::Unsupported)); }
Expect<USize> File::Write(FileHandle, const Byte*, USize) noexcept { return Expect<USize>::Err(Err(StatusDomain::System(), StatusCode::Unsupported)); }
Expect<UInt64> File::Size(FileHandle) noexcept { return Expect<UInt64>::Err(Err(StatusDomain::System(), StatusCode::Unsupported)); }
Expect<UInt64> File::Seek(FileHandle, Int64, SeekOrigin) noexcept { return Expect<UInt64>::Err(Err(StatusDomain::System(), StatusCode::Unsupported)); }
Expect<Mapping> File::Map(FileHandle, UInt64, USize, MapAccess) noexcept { return Expect<Mapping>::Err(Err(StatusDomain::System(), StatusCode::Unsupported)); }
