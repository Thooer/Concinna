...
export namespace Prm {
    template<typename T> struct IsStringViewLike : FalseType {};
    template<> struct IsStringViewLike<StringView> : TrueType {};
    inline constexpr FormatArg MakeArg(Int8 v) noexcept { FormatArg a{}; a.kind = FormatArg::Kind::I64; a.u.i64 = static_cast<Int64>(v); return a; }
    inline constexpr FormatArg MakeArg(Int16 v) noexcept { FormatArg a{}; a.kind = FormatArg::Kind::I64; a.u.i64 = static_cast<Int64>(v); return a; }
    inline constexpr FormatArg MakeArg(Int32 v) noexcept { FormatArg a{}; a.kind = FormatArg::Kind::I64; a.u.i64 = static_cast<Int64>(v); return a; }
    inline constexpr FormatArg MakeArg(Int64 v) noexcept { FormatArg a{}; a.kind = FormatArg::Kind::I64; a.u.i64 = v; return a; }
    inline constexpr FormatArg MakeArg(UInt8 v) noexcept { FormatArg a{}; a.kind = FormatArg::Kind::U64; a.u.u64 = static_cast<UInt64>(v); return a; }
    inline constexpr FormatArg MakeArg(UInt16 v) noexcept { FormatArg a{}; a.kind = FormatArg::Kind::U64; a.u.u64 = static_cast<UInt64>(v); return a; }
    inline constexpr FormatArg MakeArg(UInt32 v) noexcept { FormatArg a{}; a.kind = FormatArg::Kind::U64; a.u.u64 = static_cast<UInt64>(v); return a; }
    inline constexpr FormatArg MakeArg(UInt64 v) noexcept { FormatArg a{}; a.kind = FormatArg::Kind::U64; a.u.u64 = v; return a; }
    inline constexpr FormatArg MakeArg(Float32 v) noexcept { FormatArg a{}; a.kind = FormatArg::Kind::F64; a.u.f64 = static_cast<Float64>(v); return a; }
    inline constexpr FormatArg MakeArg(Float64 v) noexcept { FormatArg a{}; a.kind = FormatArg::Kind::F64; a.u.f64 = v; return a; }
    inline constexpr FormatArg MakeArg(const char* s) noexcept { StringView sv{s}; FormatArg a{}; a.kind = FormatArg::Kind::Str; a.u.str.data = sv.data(); a.u.str.size = sv.size(); return a; }
    inline constexpr FormatArg MakeArg(StringView sv) noexcept { FormatArg a{}; a.kind = FormatArg::Kind::Str; a.u.str.data = sv.data(); a.u.str.size = sv.size(); return a; }
    template<typename T>
    ...
    [[nodiscard]] inline FormatResult FormatTo(Span<Char8> out, StringView fmt, Span<const FormatArg> args) noexcept {
