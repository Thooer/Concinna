module;
export module Prm.Semantics:Debug;
import <cstddef>;

export namespace Prm {
    using AssertHandler = void(*)(const char* condition, const char* message, const char* file, int line, const char* function);
    namespace detail {
    ...
    inline void SetAssertHandler(AssertHandler handler) noexcept { detail::AssertHandlerStorage() = handler; }
    [[nodiscard]] inline AssertHandler GetAssertHandler() noexcept { return detail::AssertHandlerStorage(); }
