...
struct Describe {
    ...
    static consteval TypeID GetTypeID() noexcept { return ::GetTypeID<T>(); }
    ...
    template<USize I>
    static consteval USize GetMemberOffset() noexcept { return GetMemberInfo<I>().offsetBytes; }
    template<USize I>
    static consteval TypeID GetMemberTypeID() noexcept { return decltype(GetMemberInfo<I>())::GetMemberTypeID(); }
    template<USize I>
    static consteval USize GetMemberSize() noexcept { return decltype(GetMemberInfo<I>())::GetMemberSizeBytes(); }
};
template<typename T>
    requires Reflectable<T>
