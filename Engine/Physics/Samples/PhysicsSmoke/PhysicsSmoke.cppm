        ...
        for (int z = 0; z < 10; ++z) {
            for (int y = 0; y < 10; ++y) {
                for (int x = 0; x < 10; ++x) {
                    ...
                    a.min = { static_cast<Float32>(x), static_cast<Float32>(y), static_cast<Float32>(z) };
                    a.max = { static_cast<Float32>(x)+0.5f, static_cast<Float32>(y)+0.5f, static_cast<Float32>(z)+0.5f };
